      ...
      >
        ...
        <div className="mb-16 flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          ...
          <a
            ...
            className="group flex min-w-0 items-center gap-2 self-start border border-accent px-6 py-3 font-mono text-sm text-accent transition-colors hover:bg-accent hover:text-background md:self-auto"
          >
            <span className="shrink-0"><Mail size={16} /></span>
        ...
        <div className="grid w-full gap-12 lg:grid-cols-[1fr_1.3fr]">
          ...
          {/* Form */}
          <div className="min-w-0 border border-surface-light bg-surface p-6 sm:p-8">
